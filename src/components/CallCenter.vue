<script setup>
  ...
  const totalPrice = computed(() => {
    ...
    for (let i = 0; i < props.currentLocalData.length; i++) {
      total +=
        props.currentLocalData[i].price * props.currentLocalData[i].quantity;
    }
    return total;
  });
    ...
    <div class="cart">
      ...
      <div class="icon">
        ...
        <v-icon
          ...
          @click="isCartListShow = !isCartListShow"
        ></v-icon>
      </div>
      ...
      <div :class="['cart-list', {'isShow' : isCartListShow}]">
        ...
        <div class="list-container">
          <ul>
            ...
            <li
              v-for="(item,index) in currentLocalData"
              :key="index"
              v-show="hasCartList"
            >
            ...
            <li v-show="!hasCartList">購物車內尚未有任何商品</li>
          </ul>
        </div>
        <div class="confirm">
