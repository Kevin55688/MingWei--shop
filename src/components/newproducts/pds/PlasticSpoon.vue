...
const pdsData = reactive({
    ...
    items : ['規格1','規格2','規格3',],
    selected:['規格1'],
    format : [{title: '高度' , content : '150mm'},{title: '口徑' , content : '20mm'},{title: '入數/箱' , content : '3000'},{title: '每箱價格' , content : '$1000'},{title: '外箱尺寸' , content : '410*260*310mm'},],
    quantity : 1 ,
    price : 1000,
})
const minus = () => {
